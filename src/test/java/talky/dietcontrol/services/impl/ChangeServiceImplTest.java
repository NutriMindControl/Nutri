...
//        recipeDTO = new Recipe("Spaghetti Bolognese", 1L, 30, 15, 4, 600.0, 25.0, 20.0, 70.0, List.of(new IngredientsDistributionDto()));
//    }
//
//    @Test
...
//        List<Recipe> filteredRecipes = Collections.singletonList(recipeDTO);
//        Recipe result = changeService.getRecipeForParams(filteredRecipes, totalParamsDTO);
//
...
//        recipeDTO.getId(1L);
//
//        Recipe result = changeService.getChangingRecipe(1L, dailyMenuDTO);
//        assertNotNull(result);
